...
/*   Updated: 2022/01/28 14:10:11 by agunczer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		is_dead(t_time *time, t_shared *shared, int philo_id)
{
	...
	{
		// printf("%ld\n%ld\n", (time->time_now_death.tv_sec * 1000 + time->time_now_death.tv_usec / 1000) - (time->last_meal.tv_sec * 1000 + time->last_meal.tv_usec / 1000), shared->time_to_die);
		shared->death = 1;
